 ...
 */
final class Version20251128061123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD prenom VARCHAR(50) NOT NULL, ADD psuedo VARCHAR(25) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP prenom, DROP psuedo');
    }
}
