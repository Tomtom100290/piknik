 ...
 */
final class Version20251128060038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD email VARCHAR(180) NOT NULL, ADD roles JSON NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP nom, DROP prenom, DROP pseudo, DROP date_creat, DROP fk_arrondissement_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(50) NOT NULL, ADD prenom VARCHAR(50) NOT NULL, ADD pseudo VARCHAR(25) NOT NULL, ADD date_creat DATETIME NOT NULL, ADD fk_arrondissement_id INT DEFAULT NULL, DROP email, DROP roles, DROP password');
