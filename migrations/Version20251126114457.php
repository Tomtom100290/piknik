 ...
 */
final class Version20251126114457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD image_name VARCHAR(255) DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, DROP url, DROP attr_alt');
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F6047BECB FOREIGN KEY (lieu_fk_id) REFERENCES lieu (id)');
        $this->addSql('ALTER TABLE lieu ADD image_name VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD url VARCHAR(255) NOT NULL, ADD attr_alt VARCHAR(50) DEFAULT NULL, DROP image_name, DROP updated_at');
        ...
        $this->addSql('ALTER TABLE lieu DROP image_name');
