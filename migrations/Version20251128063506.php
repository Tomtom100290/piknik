 ...
 */
final class Version20251128063506 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE psuedo pseudo VARCHAR(25) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE pseudo psuedo VARCHAR(25) NOT NULL');
    }
}
