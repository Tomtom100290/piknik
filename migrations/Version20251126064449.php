 ...
 */
final class Version20251126064449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE arrondissement ADD date_creat DATETIME NOT NULL, ADD fk_commune_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_3A3B64C4E37485E1 ON arrondissement (fk_commune_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3A3B64C4E37485E1 ON arrondissement');
        $this->addSql('ALTER TABLE arrondissement DROP date_creat, DROP fk_commune_id');
