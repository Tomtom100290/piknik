 ...
 */
final class Version20251128094802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8933C4325741EEB9 ON favoris');
        $this->addSql('ALTER TABLE favoris DROP fk_user_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favoris ADD fk_user_id INT NOT NULL');
